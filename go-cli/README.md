...
AQL-driven CLI and REPL for the NidApplicationSystem SDK. Positional arguments are
...
```sh
go build -o nid-application-system-cli ./...
```
...
./nid-application-system-cli list application
./nid-application-system-cli load 1 application
./nid-application-system-cli load '{id:1}' application
