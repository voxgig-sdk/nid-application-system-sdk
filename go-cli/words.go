...
func registerSDKWords(r *eng.Registry, client *sdk.NidApplicationSystemSDK) {
...
func runOp(client *sdk.NidApplicationSystemSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
