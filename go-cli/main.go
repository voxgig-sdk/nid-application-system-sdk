// Command NidApplicationSystem-cli is a CLI + REPL for the NidApplicationSystem SDK,
...
const prompt = "nid-application-system"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "application application_status login nid_management registration success"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      NID_APPLICATION_SYSTEM_APIKEY (api key), NID_APPLICATION_SYSTEM_BASE (base url override)")
