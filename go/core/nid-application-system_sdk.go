...
type NidApplicationSystemSDK struct {
	Mode     string
...
func (sdk *NidApplicationSystemSDK) OptionsMap() map[string]any {
...
func (sdk *NidApplicationSystemSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NidApplicationSystemSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NidApplicationSystemSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NidApplicationSystemSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *NidApplicationSystemSDK {
	...
	sdk := NewNidApplicationSystemSDK(sdkopts)
	sdk.Mode = "test"
