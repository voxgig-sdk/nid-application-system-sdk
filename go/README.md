...
The Golang SDK for the NidApplicationSystem API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/nid-application-system-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/nid-application-system-sdk=../path/to/github.com/voxgig-sdk/nid-application-system-sdk
```
...
```
github.com/voxgig-sdk/nid-application-system-sdk/
...
The root package (`github.com/voxgig-sdk/nid-application-system-sdk`) re-exports everything needed
