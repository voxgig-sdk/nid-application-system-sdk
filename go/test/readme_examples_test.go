...
const testSeed = `map[string]any{"entity": map[string]any{"application": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "application_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "login": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "nid_management": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "registration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "success": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
