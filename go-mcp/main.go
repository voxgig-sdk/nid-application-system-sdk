// Command NidApplicationSystem-mcp is an MCP server exposing the NidApplicationSystem
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NidApplicationSystem_list  — list records of an entity
//	NidApplicationSystem_load  — load a single record of an entity
//
