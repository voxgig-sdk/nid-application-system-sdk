...
The Python SDK for the NidApplicationSystem API. Provides an entity-oriented interface following Pythonic conventions.
...
```python
# Create
created, _ = client.Application(None).create({"name": "Example"}, None)
...
result, err = client.NidApplicationSystem(None).load(
    {"id": "test01"}, None
)
