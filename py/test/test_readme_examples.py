# NidApplicationSystem SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NidApplicationSystemSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NidApplicationSystemSDK(...) and NidApplicationSystemSDK.test(...) become
#      NidApplicationSystemSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nidapplicationsystem_sdk"
_SDK_CLASS = "NidApplicationSystemSDK"
