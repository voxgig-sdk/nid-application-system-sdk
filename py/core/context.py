...
class NidApplicationSystemContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = NidApplicationSystemControl()
        ...
        if isinstance(sp, NidApplicationSystemSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NidApplicationSystemResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NidApplicationSystemResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return NidApplicationSystemOperation({})
    ...
    def make_error(self, code, msg):
        return NidApplicationSystemError(code, msg, self)
