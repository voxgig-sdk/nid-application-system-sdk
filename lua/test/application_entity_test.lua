...
describe("ApplicationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set NIDAPPLICATIONSYSTEM_TEST_APPLICATION_ENTID JSON to run live")
      return
    end
...
function application_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("NIDAPPLICATIONSYSTEM_TEST_APPLICATION_ENTID")
