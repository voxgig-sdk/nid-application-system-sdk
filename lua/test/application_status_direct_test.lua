...
describe("ApplicationStatusDirect", function()
  it("should direct-load-application_status", function()
    local setup = application_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-application_status", setup.live and "live" or "unit")
...
function application_status_direct_setup(mockres)
