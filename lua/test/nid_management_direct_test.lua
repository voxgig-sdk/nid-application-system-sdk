...
describe("NidManagementDirect", function()
  it("should direct-load-nid_management", function()
    local setup = nid_management_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-nid_management", setup.live and "live" or "unit")
...
function nid_management_direct_setup(mockres)
