...
function runner.env_override(m)
  local live = runner.getenv("NIDAPPLICATIONSYSTEM_TEST_LIVE")
  local override = runner.getenv("NIDAPPLICATIONSYSTEM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NIDAPPLICATIONSYSTEM_TEST_EXPLAIN")
