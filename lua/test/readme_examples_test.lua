...
local SDK_MODULE = "nid-application-system_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["application"] = { ["test01"] = { id = "test01" } }, ["application_status"] = { ["test01"] = { id = "test01" } }, ["login"] = { ["test01"] = { id = "test01" } }, ["nid_management"] = { ["test01"] = { id = "test01" } }, ["registration"] = { ["test01"] = { id = "test01" } }, ["success"] = { ["test01"] = { id = "test01" } } } }'
