...
local ApplicationStatusEntity = {}
ApplicationStatusEntity.__index = ApplicationStatusEntity


function ApplicationStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApplicationStatusEntity)
  self._name = "application_status"
  self._client = client
...
function ApplicationStatusEntity:get_name()
  return self._name
end


function ApplicationStatusEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApplicationStatusEntity.new(self._client, opts)
end


function ApplicationStatusEntity:data_set(args)
  if args ~= nil then
...
function ApplicationStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApplicationStatusEntity:match_set(args)
  if args ~= nil then
...
function ApplicationStatusEntity:match_get()
...
function ApplicationStatusEntity:stream(action, args, callopts)
...
function ApplicationStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
