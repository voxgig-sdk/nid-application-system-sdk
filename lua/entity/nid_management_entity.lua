...
local NidManagementEntity = {}
NidManagementEntity.__index = NidManagementEntity


function NidManagementEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NidManagementEntity)
  self._name = "nid_management"
  self._client = client
...
function NidManagementEntity:get_name()
  return self._name
end


function NidManagementEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NidManagementEntity.new(self._client, opts)
end


function NidManagementEntity:data_set(args)
  if args ~= nil then
...
function NidManagementEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NidManagementEntity:match_set(args)
  if args ~= nil then
...
function NidManagementEntity:match_get()
...
function NidManagementEntity:stream(action, args, callopts)
...
---@param reqmatch NidManagementLoadMatch
---@param ctrl? table
---@return NidManagement
---@return string? err
function NidManagementEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function NidManagementEntity:_run_op(ctx, post_done)
  local utility = self._utility
