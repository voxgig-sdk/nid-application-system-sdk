# NidApplicationSystem Ruby SDK

The Ruby SDK for the NidApplicationSystem API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
```ruby
# Create
created, _ = client.Application(nil).create({ "name" => "Example" }, nil)
...
result, err = client.NidApplicationSystem(nil).load(
  { "id" => "test01" }, nil
)
