...
The Ruby SDK for the NidApplicationSystem API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `NidApplicationSystemError` (a `StandardError` subclass), so wrap
