# NidApplicationSystem SDK Application entity
...
class ApplicationEntity
  ...
  #
  # @param reqdata [ApplicationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Application, Hash] the created Application; raises NidApplicationSystemError on failure
