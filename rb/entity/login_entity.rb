# NidApplicationSystem SDK Login entity
...
class LoginEntity
  ...
  # @return [Login, Hash] the current Login data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Login fields)
  def match_get
  ...
  # Create a new Login.
  #
  # @param reqdata [LoginCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Login, Hash] the created Login; raises NidApplicationSystemError on failure
