...
class NidManagementEntity
  ...
  def make
    opts = @_entopts.dup
    NidManagementEntity.new(@_client, opts)
  end
  ...
  # @return [NidManagement, Hash] the current NidManagement data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of NidManagement fields)
  def match_get
  ...
  #
  # @param reqmatch [NidManagementLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.NidManagement.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [NidManagement, Hash] the loaded NidManagement; raises NidApplicationSystemError on failure
