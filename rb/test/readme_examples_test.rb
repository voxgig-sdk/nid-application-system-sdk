...
#      offline in seeded test mode (NidApplicationSystemSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NidApplicationSystem_sdk.rb")
  SDK_CLASS = "NidApplicationSystemSDK"
  ...
  SDK_BASE = "NidApplicationSystem_sdk"
