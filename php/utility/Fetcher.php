...
// NidApplicationSystem SDK utility: fetcher

class NidApplicationSystemFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NidApplicationSystemSDK/1.0)';
    ...
    public static function call(NidApplicationSystemContext $ctx, string $fullurl, array $fetchdef): array
    {
