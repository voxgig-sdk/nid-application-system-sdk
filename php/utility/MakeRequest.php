...
// NidApplicationSystem SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NidApplicationSystemMakeRequest
{
    public static function call(NidApplicationSystemContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NidApplicationSystemResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NidApplicationSystemResponse($fetched);
        } else {
