...
// NidApplicationSystem SDK utility: result_basic

class NidApplicationSystemResultBasic
{
    public static function call(NidApplicationSystemContext $ctx): ?NidApplicationSystemResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof NidApplicationSystemError) ? $result->err->msg : (string)$result->err;
