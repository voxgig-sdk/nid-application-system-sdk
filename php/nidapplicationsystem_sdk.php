...
class NidApplicationSystemSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = NidApplicationSystemHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = NidApplicationSystemHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ($utility->feature_add)($this->_rootctx, NidApplicationSystemFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return NidApplicationSystemUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = NidApplicationSystemHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = NidApplicationSystemHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = NidApplicationSystemHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    public function direct(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = NidApplicationSystemHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new NidApplicationSystemSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
