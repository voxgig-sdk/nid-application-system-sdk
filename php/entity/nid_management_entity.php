...
class NidManagementEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NidManagementEntity($this->_client, $opts);
    }

    /**
     * @param NidManagement|array $args NidManagement data (assoc-array) to store.
     */
    ...
    /**
     * @return NidManagement|array The current NidManagement data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of NidManagement fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of NidManagement fields).
     */
    ...
    /**
     * Load a single NidManagement.
     *
     * @param NidManagementLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed NidManagementLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return NidManagement|array The loaded NidManagement as an assoc-array at the
