...
// NidApplicationSystem SDK pipeline test
//
...
{
    private static function utility(): NidApplicationSystemUtility
    {
        return new NidApplicationSystemUtility();
    }
    ...
    private static function ctx(array $over = []): NidApplicationSystemContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NidApplicationSystemContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NidApplicationSystemOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NidApplicationSystemError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NidApplicationSystemOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NidApplicationSystemMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NidApplicationSystemOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NidApplicationSystemMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NidApplicationSystemOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NidApplicationSystemMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NidApplicationSystemSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NidApplicationSystemMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NidApplicationSystemResponse([]),
            'result' => new NidApplicationSystemResult([]),
        ]);
        [, $err] = NidApplicationSystemMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NidApplicationSystemSpec([]),
            'response' => null,
            'result' => new NidApplicationSystemResult([]),
        ]);
        [, $err] = NidApplicationSystemMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NidApplicationSystemSpec(['step' => 's']),
            'response' => new NidApplicationSystemResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NidApplicationSystemResult([]),
        ]);
        [, $err] = NidApplicationSystemMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NidApplicationSystemSpec(['step' => 's']),
            'response' => new NidApplicationSystemResponse(self::resp(200, ['v' => 1])),
            'result' => new NidApplicationSystemResult([]),
        ]);
        [, $err] = NidApplicationSystemMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NidApplicationSystemSpec(['step' => 's']),
            'response' => new NidApplicationSystemResponse(self::resp(200, ['v' => 2])),
            'result' => new NidApplicationSystemResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NidApplicationSystemMakeResponse::call($ctx);
    ...
    {
        $preset = new NidApplicationSystemResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NidApplicationSystemSpec([]),
            'response' => new NidApplicationSystemResponse([]),
            'result' => new NidApplicationSystemResult([]),
        ...
        [$got, $err] = NidApplicationSystemMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NidApplicationSystemResult([])]);
        [, $err] = NidApplicationSystemMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NidApplicationSystemSpec([]), 'result' => null]);
        [, $err] = NidApplicationSystemMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NidApplicationSystemSpec(['step' => 's']),
            'result' => new NidApplicationSystemResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NidApplicationSystemOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NidApplicationSystemMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NidApplicationSystemSpec(['step' => 's']),
            'result' => new NidApplicationSystemResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NidApplicationSystemOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NidApplicationSystemMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NidApplicationSystemResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NidApplicationSystemSpec([]),
            'result' => new NidApplicationSystemResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NidApplicationSystemMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NidApplicationSystemMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NidApplicationSystemError('boom', 'boom');
        $utility->fetcher = function (NidApplicationSystemContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NidApplicationSystemSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NidApplicationSystemMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NidApplicationSystemContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NidApplicationSystemMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NidApplicationSystemResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NidApplicationSystemMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NidApplicationSystemContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NidApplicationSystemSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NidApplicationSystemMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NidApplicationSystemResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NidApplicationSystemSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NidApplicationSystemMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NidApplicationSystemMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NidApplicationSystemMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NidApplicationSystemResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NidApplicationSystemDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NidApplicationSystemResult(['ok' => false])]);
        $this->expectException(NidApplicationSystemError::class);
        NidApplicationSystemDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NidApplicationSystemResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NidApplicationSystemMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NidApplicationSystemMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NidApplicationSystemBaseFeature();
        $b = new NidApplicationSystemBaseFeature();
        NidApplicationSystemFeatureAdd::call($ctx, $a);
        NidApplicationSystemFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NidApplicationSystemBaseFeature
    {
        $f = new NidApplicationSystemBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NidApplicationSystemFeatureAdd::call($ctx, self::named_feature('a'));
        NidApplicationSystemFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        NidApplicationSystemFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        NidApplicationSystemFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        NidApplicationSystemFeatureAdd::call($ctx, $replace);
        ...
        NidApplicationSystemFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NidApplicationSystemContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NidApplicationSystemSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NidApplicationSystemPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NidApplicationSystemPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NidApplicationSystemResponse(['headers' => null]),
            'result' => new NidApplicationSystemResult([]),
        ]);
        NidApplicationSystemResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NidApplicationSystemResultBody::call($ctx);
