...
class ApplicationEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set NIDAPPLICATIONSYSTEM_TEST_APPLICATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function application_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("NIDAPPLICATIONSYSTEM_TEST_APPLICATION_ENTID");
