...
class ApplicationStatusDirectTest extends TestCase
{
    public function test_direct_load_application_status(): void
    {
        $setup = application_status_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-application_status", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
