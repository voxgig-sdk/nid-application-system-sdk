...
// NidApplicationSystem SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NidApplicationSystemSDK::test)
...
{
    private const SDK_CLASS = 'NidApplicationSystemSDK';
    ...
    private const SDK_BASE = 'nidapplicationsystem_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nidapplicationsystem_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
