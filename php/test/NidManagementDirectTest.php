...
class NidManagementDirectTest extends TestCase
{
    public function test_direct_load_nid_management(): void
    {
        $setup = nid_management_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-nid_management", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
