...
// NidApplicationSystem SDK clienttrack feature
...
class NidApplicationSystemClienttrackFeature extends NidApplicationSystemBaseFeature
{
    ...
    public function PostConstruct(NidApplicationSystemContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NidApplicationSystem-SDK';
