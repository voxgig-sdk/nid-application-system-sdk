...
// NidApplicationSystem SDK telemetry feature
...
class NidApplicationSystemTelemetryFeature extends NidApplicationSystemBaseFeature
{
    ...
    private function _close(NidApplicationSystemContext $ctx, bool $ok): void
    {
