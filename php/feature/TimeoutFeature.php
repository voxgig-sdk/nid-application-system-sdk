...
// NidApplicationSystem SDK timeout feature
...
class NidApplicationSystemTimeoutFeature extends NidApplicationSystemBaseFeature
{
    ...
    private function _with_timeout(NidApplicationSystemContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NidApplicationSystemContext $_ctx, float $ms): void
    {
        $client = $this->client;
