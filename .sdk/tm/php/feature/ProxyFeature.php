...
// NidApplicationSystem SDK proxy feature
...
class NidApplicationSystemProxyFeature extends NidApplicationSystemBaseFeature
{
    ...
    public function init(NidApplicationSystemContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NidApplicationSystemContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
