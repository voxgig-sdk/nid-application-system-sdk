...
// NidApplicationSystem SDK audit feature
...
class NidApplicationSystemAuditFeature extends NidApplicationSystemBaseFeature
{
    ...
    private function _emit(NidApplicationSystemContext $ctx, string $outcome): void
    {
