...
// NidApplicationSystem SDK cache feature
...
class NidApplicationSystemCacheFeature extends NidApplicationSystemBaseFeature
{
    ...
    private function _through(NidApplicationSystemContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
