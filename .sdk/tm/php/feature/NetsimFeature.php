...
// NidApplicationSystem SDK netsim feature
...
class NidApplicationSystemNetsimFeature extends NidApplicationSystemBaseFeature
{
    ...
    private function _simulate(NidApplicationSystemContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NidApplicationSystemContext $ctx, array $applied): void
    {
        $client = $this->client;
