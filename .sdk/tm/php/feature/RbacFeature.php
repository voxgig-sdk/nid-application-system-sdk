...
// NidApplicationSystem SDK rbac feature
...
class NidApplicationSystemRbacFeature extends NidApplicationSystemBaseFeature
{
    ...
    private function _required(NidApplicationSystemContext $ctx): ?string
    {
    ...
    private function _reject(NidApplicationSystemContext $ctx, string $required): void
    {
    ...
    private function _track(NidApplicationSystemContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
