...
// NidApplicationSystem SDK ratelimit feature
...
class NidApplicationSystemRatelimitFeature extends NidApplicationSystemBaseFeature
{
    ...
    private function _acquire(NidApplicationSystemContext $ctx): void
    {
    ...
    private function _track(NidApplicationSystemContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
