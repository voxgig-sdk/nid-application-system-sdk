...
// NidApplicationSystem SDK utility type

class NidApplicationSystemUtility
{
    ...
    public static function copy(NidApplicationSystemUtility $src): NidApplicationSystemUtility
    {
        $u = new NidApplicationSystemUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
