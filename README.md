...
The Bangladesh NID Application System API allows users to register for a national identity card, claim their accounts, and manage related services through a web-based platform.

Learn more about NID Application System at [services.nidw.gov.bd](https://services.nidw.gov.bd).

This is an unofficial SDK for the NID Application System public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
```go
client := sdk.Test()
result, err := client.ApplicationStatus(nil).Load(
