...
describe('ApplicationStatusDirect', async () => {
  ...
  test('direct-load-application_status', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-application_status', setup.live)) return
