...
class ApplicationStatusEntity extends NidApplicationSystemEntityBase {
  ...
  constructor(client: NidApplicationSystemSDK, entopts: any) {
    ...
    this.name = 'application_status'
    this.name_ = 'application_status'
    this.Name = 'ApplicationStatus'
  }


  make(this: ApplicationStatusEntity) {
    return new ApplicationStatusEntity(this._client, this.entopts())
  }
